...
def fit_test_sec(hidden_nodes=vocablen, second_hidden_nodes=vocablen, lr=0.001, m=0.0, bs=100, r=0.0, epochs_num=100, plot=[("loss","val_loss")]):
    # Arrays for storing loss sum, accuracy sum and MSE sum of all five training iterations
    loss_sum = np.zeros(epochs_num)
    val_loss_sum = np.zeros(epochs_num)
    acc_sum = np.zeros(epochs_num)
            ...
            if lr == 0.1:
                if m == 0.0:
                    if r == 0.0:
                        ...
                        plt.savefig("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.1/"+plot[j][0]+".png")
                    elif r == 0.5:
                        plt.savefig("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.5/"+plot[j][0]+".png")
                    elif r == 0.9:
                        plt.savefig("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.9/"+plot[j][0]+".png")
                elif m == 0.6:
...
# Fit and plot for different l2 kernel regularization

l01 = fit_test_sec(hidden_nodes=20, second_hidden_nodes=10, lr=0.1, m=0.0, r=0.1, epochs_num=200, plot=[("loss","val_loss"),("accuracy", "val_accuracy"), ("mean_squared_error", "val_mean_squared_error")])
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.1/loss.npy", np.asarray(l01["loss"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.1/val_loss.npy", np.asarray(l01["val_loss"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.1/accuracy.npy", np.asarray(l01["accuracy"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.1/val_accuracy.npy", np.asarray(l01["val_accuracy"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.1/mean_squared_error.npy", np.asarray(l01["mean_squared_error"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.1/val_mean_squared_error.npy", np.asarray(l01["val_mean_squared_error"]))

l05 = fit_test_sec(hidden_nodes=20, second_hidden_nodes=10, lr=0.1, m=0.0, r=0.5, epochs_num=200, plot=[("loss","val_loss"),("accuracy", "val_accuracy"), ("mean_squared_error", "val_mean_squared_error")])
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.5/loss.npy", np.asarray(l05["loss"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.5/val_loss.npy", np.asarray(l05["val_loss"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.5/accuracy.npy", np.asarray(l05["accuracy"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.5/val_accuracy.npy", np.asarray(l05["val_accuracy"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.5/mean_squared_error.npy", np.asarray(l05["mean_squared_error"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.5/val_mean_squared_error.npy", np.asarray(l05["val_mean_squared_error"]))

l09 = fit_test_sec(hidden_nodes=20, second_hidden_nodes=10, lr=0.1, m=0.0, r=0.9, epochs_num=200, plot=[("loss","val_loss"),("accuracy", "val_accuracy"), ("mean_squared_error", "val_mean_squared_error")])
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.9/loss.npy", np.asarray(l09["loss"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.9/val_loss.npy", np.asarray(l09["val_loss"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.9/accuracy.npy", np.asarray(l09["accuracy"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.9/val_accuracy.npy", np.asarray(l09["val_accuracy"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.9/mean_squared_error.npy", np.asarray(l09["mean_squared_error"]))
np.save("/content/drive/MyDrive/Υπολογιστική Νοημοσύνη/1η εργασία/hidden20/sec_hidden10/r0.9/val_mean_squared_error.npy", np.asarray(l09["val_mean_squared_error"]))